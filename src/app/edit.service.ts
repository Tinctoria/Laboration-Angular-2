...
export class EditService {
  ...
  questions: Question[] = [
    ...
    new Question (2, 'Förklara vad Angular är och varför det används', 'SPAer är webbapplikationer eller webbplatser som endast laddar in en websida. Denna förändras med användarens interaktion genom att skriva om webbsidans innehåll på ett dynamiskt vis.'),
